...
?>
			<div class="postbox">
				<h3 class='hndle' style="padding:5px;"><span><?php _e('Affiliate Royale Integration', CPIS_TEXT_DOMAIN); ?></span></h3>
				<div class="inside">
					<?php _e('If the Affiliate Royale plugin is installed on the website, and you want integrate it with the  Store, tick the checkbox:', CPIS_TEXT_DOMAIN); ?>
